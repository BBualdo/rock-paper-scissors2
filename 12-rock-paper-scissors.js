...
document.querySelector('.js-reset-button')
  .addEventListener('click', () => {
    const divElement = document.querySelector('.reset-confirmation');
    const confirmReset = `<p>Are you sure you want to reset the score?
    </p>
    <button class="confirm-reset-button">Yes</button>
    <button class="decline-reset-button">No</button>`
    divElement.innerHTML = confirmReset
    
    const confirm = document.querySelector('.confirm-reset-button');
    const decline = document.querySelector('.decline-reset-button');
